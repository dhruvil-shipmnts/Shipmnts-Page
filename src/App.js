  ...
  return (
    <>
      ...
      <ColorScreens {...content[0]}>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti laborum esse suscipit
        temporibus fugit numquam illo placeat eum eaque architecto excepturi dolor sint rem, ipsum
        error aspernatur qui explicabo veniam!
      </ColorScreens>
      <ColorScreens {...content[1]}>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore placeat aut totam fugit
        et explicabo recusandae vitae sunt sit quisquam officiis reprehenderit nostrum quidem rem,
        eos debitis magnam consequatur. Pariatur!
      </ColorScreens>
      <ColorScreens {...content[2]}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit est quis earum nam
        doloremque, vero excepturi architecto repellat voluptatem laboriosam! Corporis repellat
        illum vero blanditiis quam itaque vel minus eum!
      </ColorScreens>
      <PricingComponent />
      <AboutSection />
    </>
