  ...
  },
  {
    ...
    images: [
      ...
      },
      {
        ...
        title:
          "Auto hold shipments with low margin or credit heavy customers",
      },
      {
        imgSrc: MonitorShipment,
        title:
          "Monitor shipment progress, track and resolve exception faster",
      },
      {
        imgSrc: KnowYourCustomer,
        title:
          "Know which customers to stop doing business with all metrics in one place",
      },
      {
